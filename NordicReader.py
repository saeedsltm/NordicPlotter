...
line_E = {'GAP':  {'col':(5,8),    'fmt':'%3d'    ,'v':None},          'ORT': {'col':(14,20),   'fmt':'%6.2f'  ,'v':None},
          'LAE':  {'col':(24,30),  'fmt':'%6.1f'  ,'v':None},          'LOE': {'col':(32,38),   'fmt':'%6.1f'  ,'v':None},
          'DEE':  {'col':(38,44),  'fmt':'%5.1f'  ,'v':None},          'CXY': {'col':(44,55),   'fmt':'%12.4e' ,'v':None},
          'CXZ':  {'col':(55,67),  'fmt':'%12.4e' ,'v':None},          'CYZ': {'col':(67,79),   'fmt':'%12.4e' ,'v':None}}
...
def Read_Nordic(inp='select.out'):
    ...
    with open(inp) as f:
        ...
        #__________ Sec 03 Read Line Type 4:
            ...
            if flag_l4 and l[1:5] != 'STAT':
                ...
                for j in sorted(line_4.keys()):
                    ...
                    if 'P' in l[10:11].upper():

                        nor_dic[EID]['PHASE'][s]['P'][j] = v

                    elif 'S' in l[10:11].upper():

                        nor_dic[EID]['PHASE'][s]['S'][j] = v
